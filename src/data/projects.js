...
export const projects = [
    ...
    {id: 2, title: 'Todo list', description: 'Todo is an react-app made with typescript. Is the convencional list of things to do. You can create, and mark as done', image: imc, link: 'https://todo-react-list.vercel.app/', 
        tecnologies: [
