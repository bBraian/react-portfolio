...
export const projects = [
    ...
    {id: 2, title: 'Unisinos Groups', description: 'This project is basically a list to store the whatsapp groups of the classes from college', image: unisinos, link: 'https://unisinos-groups.vercel.app/', projectStatus: '', 
        tecnologies: [
            {id: 3, name: 'ReactJS', icon: react}
        ]
    },
